<div>
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{$destinos}}</span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
                <span class="info-box-icon bg-warning"><i class="fas fa-snowboarding"></i></span>

                <div class="info-box-content">
                    <span class="info-box-text">Actividades</span>
                    <span class="info-box-number">{{$actividades}}</span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">Puntos de Interes</span>
